...
public class Fire extends Pokemon{
    ...
    public static Pokemon charmander = new Fire("Charmander",52,43,65,"Charmander",142,ZMoves.INFERNO_OVERDRIVE_CHARMANDER);
    public static Pokemon torchic = new Fire("Torchic",60,40,45,"Torchic",134,ZMoves.INFERNO_OVERDRIVE_TORCHIC);
    public static Pokemon tepig = new Fire("Tepig",63,45,45,"Tepig",139,ZMoves.INFERNO_OVERDRIVE_TEPIG);
